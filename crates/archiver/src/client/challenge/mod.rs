...
//!
//! Each recognizer handles a specific challenge format and derives an answer without executing the
//! page's script. Unrecognized pages are archived unchanged.
//!
...
//! answer with another challenge is answered
