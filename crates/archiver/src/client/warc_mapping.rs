...
///
/// A `304 Not Modified` to a conditional request is written as a `server-not-modified` revisit of
/// the capture it revalidated; otherwise a match in `revisit_of` is written as an
