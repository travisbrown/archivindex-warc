...
///
/// Repeated values are combined as by
/// [`combined_header`](archivindex_warc::record::http::RequestMetadata::combined_header). Missing
/// or non-UTF-8 values are reported as absent.
...
impl Original {
    ...
    /// The request headers extended with the preconditions under which the server may answer `304
    /// Not Modified` instead of repeating the payload.
