//! Rules 3, 4, and 5: header fields in canonical order, an identifier no earlier record used, and a
//! date no earlier than the record before.
...
impl<R: BufRead> Linter<'_, R> {
    ...
    /// used this record's identifier and that the record is dated no earlier than the record before
    /// it, remembering both.
