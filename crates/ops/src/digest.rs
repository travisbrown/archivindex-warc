...
/// one gzip member per record. A temporary file beside `output` is moved into place after the last
/// record is written.
///
/// # Errors
///
...
/// The labelled digest of the framed message body, or `None` when the declared digest already is
/// it.
///
