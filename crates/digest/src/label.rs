...
///
/// Equality compares the named algorithm rather than its spelling. Custom labels ignore ASCII case;
/// known labels also ignore compatibility spelling.
#[derive(Clone, Debug)]
...
pub fn algorithm(label: &str) -> Option<(Algorithm, bool)> {
