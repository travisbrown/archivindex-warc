...
impl Algorithm {
    ...
    ///
    /// Use Base32 for SHA-1 and Base16 for the other algorithms. This follows annotation #80's rule
    /// to avoid Base32 padding, including for XXH128 despite its conflicting table entry.
    #[must_use]
