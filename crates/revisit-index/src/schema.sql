...
CREATE TABLE IF NOT EXISTS resource_state (
    ...
    -- The request fields that select the stored representation, NULL when the response declared no
    -- `Vary`. Validators are reusable only for a request matching this.
    variance         TEXT,
