...
//! check values or repeated fields against the declared version and record type. Values are
//! presented as they are spelled: the encoded words of RFC 2047 are not decoded, following
//! community recommendation #67 of the annotated WARC 1.1 standard, as the [crate
//! documentation](crate) describes.
