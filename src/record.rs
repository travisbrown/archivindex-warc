...
impl Record<EmptyBody> {
    ...
    fn parse_record_date(version: WarcVersion, date: &str) -> Result<DateTime<Utc>, WarcError> {
        let parsed = if version == WarcVersion::V1_0 {
...
mod record_tests {
    ...
    fn display_empty_record_renders_full_header_block() {
        ...
        assert!(rendered.starts_with("Record(WARC/1.1"), "{}", rendered);
        for expected in [
            "warc-type: resource",
...
mod builder_tests {
    ...
    fn verify_build_date() {
        ...
        builder = builder
            .date(Record::parse_record_date(crate::WarcVersion::V1_0, DATE_STRING_0).unwrap());
