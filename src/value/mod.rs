...
mod tests {
    ...
    /// A rule is named without the field whose value failed it, since the same rule serves several
    /// fields and [`crate::parse::untyped::Error`] is what supplies the name.
    #[test]
