...
/// as bytes rather than as text. An RFC 2047 encoded word in the value is held as it was read,
/// since the crate does not implement the mechanism (see the [crate documentation](crate)).
...
mod tests {
    ...
    /// A `TEXT` value reads back as written, quoting and escapes included.
    #[proptest]
