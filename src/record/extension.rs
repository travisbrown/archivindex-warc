...
/// [`CoreHeaders::unrecognized`](crate::record::header::CoreHeaders::unrecognized). During writing,
/// the extension appends its field lines. The `()` implementation claims and appends nothing.
