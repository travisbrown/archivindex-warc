...
//!
//! Clause 5.17 of the WARC 1.1 standard requires this field to carry a type determined by
...
/// The media type an HTTP message's first well-formed `Content-Type` field declares.
